...
export class Shop extends Component {
  ...
  handleOpenSidebarClick() {
    this.props.dispatch(
      changeStateValue({
        name: "filterOverlayVisible",
        value: true,
      })
    );
  }
  handleCloseSidebarClick(e) {
    if (e.target.classList.contains("secondary_overlay") || e.target.classList.contains("close")) {
      this.props.dispatch(
        changeStateValue({
          name: "filterOverlayVisible",
          value: false,
  ...
  render() {
    ...
    const { swiperOverlayVisible, filterOverlayVisible } = this.props;
    return (
      <main>
        <Title title={"shop"} />
        <section id="content">
          <div className="container">
            <div className="content_all d-flex">
              ...
              <div
                className="secondary_overlay"
                onClick={this.handleCloseSidebarClick.bind(this)}
                style={{ width: filterOverlayVisible ? "100%" : "0%" }}
              >
                <div
                  className="secondary_overlay_sidebar"
                  style={{ width: filterOverlayVisible ? "330px" : "0" }}
                >
                  <div className="secondary_box title d-flex">
                    <h3>Filter</h3>
                    <button id="btn" className="close" onClick={this.handleCloseSidebarClick.bind(this)}>
                      close X
                    </button>
                  </div>
                  <div className="secondary_box">
              ...
              <div className="primary">
                <div className="top d-flex-center">
                  ...
                  <div className="filter">
                    <button onClick={() => this.handleOpenSidebarClick()}>
...
const mapStateToProps = (state) => ({
  ...
  filterOverlayVisible: state.Data.filterOverlayVisible,
});
